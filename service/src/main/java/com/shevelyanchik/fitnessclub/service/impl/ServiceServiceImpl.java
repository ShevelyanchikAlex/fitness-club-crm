...
import com.shevelyanchik.fitnessclub.model.mapper.ServiceMapper;
import com.shevelyanchik.fitnessclub.persistence.ServiceRepository;
...
public class ServiceServiceImpl implements ServiceService {
    ...
    public ServiceDto save(ServiceDto serviceDto) {
        com.shevelyanchik.fitnessclub.model.domain.Service entity = serviceMapper.toEntity(serviceDto);
        com.shevelyanchik.fitnessclub.model.domain.Service savedService = serviceRepository.save(entity);
